...
STRINGS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "apps": "Try it",
        "appAsk": "Type something",
        "appSend": "Send",
        "appOff": "This runs on the machine that publishes this site.",
    ...
    "fr": {
        ...
        "apps": "Essayer",
        "appAsk": "Écrivez quelque chose",
        "appSend": "Envoyer",
        "appOff": "Fonctionne sur la machine qui publie ce site.",
    ...
    "es": {
        ...
        "appAsk": "Escriba algo",
        "appSend": "Enviar",
        "appOff": "Funciona en la máquina que publica este sitio.",
    ...
    "de": {
        ...
        "apps": "Ausprobieren",
        "appAsk": "Schreiben Sie etwas",
        "appSend": "Senden",
        "appOff": "Läuft auf dem Rechner, der diese Seite veröffentlicht.",
    ...
    "it": {
        ...
        "apps": "Prova",
        "appAsk": "Scrivi qualcosa",
        "appSend": "Invia",
        "appOff": "Gira sulla macchina che pubblica questo sito.",
    ...
    "pt": {
        ...
        "appAsk": "Escreva algo",
        "appSend": "Enviar",
        "appOff": "Funciona na máquina que publica este site.",
    ...
    "nl": {
        ...
        "appAsk": "Typ iets",
        "appSend": "Versturen",
        "appOff": "Draait op de machine die deze site publiceert.",
