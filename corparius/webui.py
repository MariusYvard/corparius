...
def _overview(state: UiState, slug: str) -> dict:
    ...
    The service takes the run as a parameter — that one line, `state.runs`, was the whole reason
    a terminal could not have this, exactly as `state.chats` was for the chat.
    """
