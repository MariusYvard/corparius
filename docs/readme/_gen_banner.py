...
DARK = dict(
    bg0="#081A3E", bg1="#061232", dots="#537CD6", text="#EFF4FC", muted="#9AA5BB",
    kicker="#8CCBFF", accent="#2456D3", warm="#EB933B", teal="#64B8D2", border="#254387",
    warmsoft="#2A1F10", dotop="0.20", logofx="", haloop="0.55",
)
LIGHT = dict(
    bg0="#FFFFFF", bg1="#EEF2F9", dots="#B7C2D8", text="#142752", muted="#475572",
    kicker="#2456D3", accent="#2456D3", warm="#AA5900", teal="#2E7D96", border="#CAD1DF",
    warmsoft="#F3E9D8", logofx='filter="url(#ink)"', haloop="0.30", dotop="0.55",
)


def svg(p):
    ink = ("" if p["logofx"] == "" else
           '<filter id="ink"><feComponentTransfer>'
