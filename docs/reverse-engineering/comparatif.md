...
Positionnement de corparius face aux plateformes de référence. Les figures sur NanoCorp, Polsia, Uclic, OpenWorker, Hermes Agent et NOOA sont détaillées dans les fiches dédiées.
...
| NOOA (NVIDIA labs) | une bibliothèque : l'agent est un objet Python, le modèle exécute du code | auto-hébergé, bibliothèque | validation AST et liste de modules interdits, insuffisantes de son propre aveu sans bac à sable OS | selon l'intégration |
