...
def test_the_doctor_reads_the_cache_and_never_measures(tmp_path, monkeypatch):
    """A measurement costs a real generation — 93 seconds to load the configured
    model on the machine this was written for. The doctor runs on every launcher
