...
# in two places because the console was already computing three of the four for its Go live
# card, and two computations of one fact is how they come to disagree.
